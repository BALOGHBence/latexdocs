...
version = latexdocs.__version__
# The full version, including alpha/beta/rc tags.
release = latexdocs.__version__ + '-git'
...
latex_documents = [
    ('index', 'latexdocs.tex', u'latexdocs Documentation',
...
man_pages = [
    ('index', 'latexdocs', u'latexdocs Documentation',
     [u'Bence Balogh'], 1)
]
...
texinfo_documents = [
    ('index', 'latexdocs', u'latexdocs Documentation',
     u'Bence Balogh', 'latexdocs', 'One line description of project.',
     'Miscellaneous'),
]
...
"""html_context = {
    ...
    'versions': (
        ('dev', 'https://github.com/dewloosh/latexdocs/tree/main'),
        ('stable', 'https://github.com/dewloosh/latexdocs/tree/main'),
    )
}"""